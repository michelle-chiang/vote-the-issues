const issueData = {
    ...
    'Healthcare': [
        ...
        'The Affordable Care Act... works. Why is Congress so eager to repeal it?'
    ],
    'Economic Sanity': [
    ...
    'Criminal Justice': [
        'Jail time shouldn’t depend on whether or not you can pay bail.',
        'Felony disenfranchisement is racist, partisan, and mean-spirited.',
        'Mass incarceration is still shredding my community.'
    ],
    'Students': [
        'Education is forever. Student loans shouldn’t be.',
        'We marched together. Now it’s time to vote together.',
        'My future is online. We need net neutrality to keep corporate monopolies out of the way.'
    ]
}
